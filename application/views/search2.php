              ...
              <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <!--<div class="modal fade" id="get_Modal" tabindex="-1" role="dialog" aria-labelledby="get_ModalLabel" >
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    <h4 class="modal-title" id="get_ModalLabel">下载文件</h4>
                                    </div>
                                    <div class="modal-body">
                                        <form>
                                            <div class="form-group">
                                                <label for="message-text" class="control-label">选择文件:</label>
                                                <input type="file" class="form-control" id="getfileContent" />
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                <button type="button" class="btn btn-primary" id="get_file_btn">下载</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
